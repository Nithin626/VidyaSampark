...
const Hero = () => {
    ...
    return (
        <section id="home-section" className='bg-slateGray'>
                <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4 pt-10 pb-8 lg:pt-16">
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1 items-center'>
                    <div className='col-span-6 flex flex-col gap-8 '>
                        ...
                        <h1 className='text-midnight_text text-4xl sm:text-5xl font-semibold pt-2 lg:pt-0'>
                        Advance your career with us.
                        </h1>
                        <h3 className='text-black/70 text-lg pt-3 lg:pt-1'>
                        Build skills with our partner universities and avail placements in top companies.
                        </h3>
                        ...
                        */}
                        <div className='flex items-center justify-between pt-10 lg:pt-4'>
                            <div className='flex gap-2'>
                                ...
                                <p className='text-sm sm:text-lg font-normal text-black'>Skills</p>
                            </div>
                            <div className='flex gap-2'>
                                <Image src={`${getImagePrefix()}images/banner/check-circle.svg`} alt="check-image" width={30} height={30} className='smallImage' />
                                <p className='text-sm sm:text-lg font-normal text-black'>Effective Learning</p>
                            </div>
                            <div className='flex gap-2'>
                                <Image src={`${getImagePrefix()}images/banner/check-circle.svg`} alt="check-image" width={30} height={30} className='smallImage' />
                                <p className='text-sm sm:text-lg font-normal text-black'>Industry Ready</p>
                            </div>
                        </div>
