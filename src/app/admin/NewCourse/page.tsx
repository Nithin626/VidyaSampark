//src\app\admin\NewCourse\page.tsx
'use client';
...
export default function NewCoursePage() {
  ...
  const [syllabus, setSyllabus] = useState(''); // New state for syllabus
  const [jobsInfo, setJobsInfo] = useState(''); // New state for jobs info
  ...
  // --- Handler to load course data into the edit form ---
  const handleLoadCourseForEdit = (courseId: string) => {
      ...
      if (course) {
          ...
          // Stringify the JSON so it can be displayed and edited in the textarea
